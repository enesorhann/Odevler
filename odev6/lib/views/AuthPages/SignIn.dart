...
import 'package:odev6/views/AuthPages/SignUp.dart';
import 'package:odev6/views/Pages/DrawerPage.dart';
                      ...
                      onPressed: () async {
                        if (key.currentState!.validate()) {
                          var user = await Services()
                              .kullaniciVerisiGetir(uName.text, pasw.text);
                          if (user != null) {
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => DrawerPage(user)));
                          } else {
